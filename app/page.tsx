    ...
    <div className="min-h-screen bg-slate-100">
      <div className="max-w-2xl mx-auto p-8 space-y-12">
        ...
        <div className="bg-white border border-black py-8 px-6 sm:px-12 space-y-6">
          <div className="font-mono text-2xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-6xl font-bold text-center text-green-600 tabular-nums flex justify-center">
